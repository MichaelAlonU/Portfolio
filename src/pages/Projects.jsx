...
import aiPortfolioView from '../assets/aiPortfolioView.png';
import GatewayView from '../assets/aiMultiProviderView.gif';

const featuredProjectImages = {
  vacationView: VacationView,
  aiPortfolioView: aiPortfolioView,
  aiMultiProviderView: GatewayView,
};
  ...
  return (
    <div>
      ...
      >
        <div className="row">
          {featured.map((project) => {
            const projectImage = featuredProjectImages[project.image];

            return (
              <div key={project.id} data-fade className="mb-4">
                  ...
                  <div className="row g-4">
                    <div className="col-lg-8">
                      <div className="d-flex justify-content-between align-items-start mb-3">
                        ...
                        <div style={{ fontSize: '3rem', opacity: 0.6, color: 'hsla(39, 100%, 69%, 0.95)' }}>★</div>
                      </div>
                    ...
                    <div className="col-lg-4 d-flex flex-column justify-content-between">
                      <div
                        onClick={() => projectImage && setActiveModalProject(project)}
                        style={{
                          maxHeight: '280px',
                          width: '90%',
                          aspectRatio: '1',
                          ...
                          marginBottom: '1rem',
                          textAlign: 'center',
                          cursor: projectImage ? 'pointer' : 'default',
                      ...
                      >
                        ...
                        >
                          {projectImage ? (
                            ...
                            <span className="text-secondary small">Image coming soon</span>
                          )}
                        </div>
                      </div>
      ...
      <Section
        ...
        subtitle="Additional backend and system design projects"
        ...
        <div className="row">
          {additional.map((project) => (
            <div key={project.id} className="col-md-6 mb-4">
              <Card data-fade>
                <div className="mb-3">
                  <h5 className="h5 fw-bold text-white mb-2">{project.title}</h5>
                ...
                <Button
                  variant="ghost"
                  href={project.github}
                  className="w-100 text-center text-orange"
                  target="_blank"
                  rel="noopener noreferrer"
                  style={{ width: '100%', color: '#fdaa2d' }}
                >
                  <svg
                    className="icon"
                    width="16"
      ...
      {activeModalProject && (
        ...
        >
          ...
          >
            <img
              src={featuredProjectImages[activeModalProject.image]}
